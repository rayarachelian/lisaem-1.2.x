...
{
 uint32 sector, i;
 int as=RESERVED_BLOCKS    ;   // sector is the search for the allocation bitmap, as is the active sector
...
void version_banner(void)
{
  ...
  puts("  ---------------------------------------------------------------------------");
  puts("    Lisa File System Shell Tool  v0.67     http://lisaem.sunder.net/lisafsh  ");
  puts("  ---------------------------------------------------------------------------");
  puts("          Copyright (C) MMVI, Ray A. Arachelian, All Rights Reserved.");
       ...
       case LOADPROFILE_CMD:
            {
             ...
             long sector_number=0, last_sector=0x00fffffd, offset=-4;
